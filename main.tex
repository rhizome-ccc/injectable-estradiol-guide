...
\begin{figure}
  \centering
  \includegraphics[width=10em]{simulator-qr}
...
\begin{figure}
  \centering
  \includegraphics[width=10em]{cliniq-qr}
...
\begin{figure}
  \centering
  \includegraphics[width=10em]{needle-exchange-qr}
...
\begin{figure}
  \centering
  \includegraphics[width=10em]{drawing-up-video-qr}
  \hspace{2em}
  \includegraphics[width=10em]{im-injection-video-qr}
...
\begin{center}
  \null\vfill
  \includegraphics[width=10em]{repo-qr} \\
  \vspace{1.2em}
  \parbox{0.8\textwidth}{
    The latest version of this
    guide, as well as its issue tracker and source code are available
